...
exports.run = (client, message, args) => {
  ...
  if (!channel.permissionsFor(client.user).has(['VIEW_CHANNEL', 'SEND_MESSAGES', 'EMBED_LINKS'])) return message.reply(':x: I do not have enough permissions in the bugs channel! Please make sure I have all the following permissions.\n\n`View Channel\nSend Messages\nEmbed Links`');
